    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-section">
          ...
          <p>Author of "Greatness Through Persecution"</p>
          <p className="tagline">Black Athletes' Moment of Will for Overcoming Racism and Hardship</p>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li><Link to="/about-will">About the Author</Link></li>
      ...
      <div className="footer-bottom">
          ...
          <p>Website designed by <a href="https://brilliantsonbedford.com" target="_blank" rel="noopener noreferrer">BrilliantsonBedford</a></p>
      </div>
    </footer>
  )
}
